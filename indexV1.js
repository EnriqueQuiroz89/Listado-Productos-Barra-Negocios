...
const DOMnegocios = document.querySelector('#menu-negocios');
    ...
    articulosRef
        ...
        .onSnapshot((querySnapshot) => {
            ...
            querySnapshot.forEach((doc) => {
                ...
                miNodoTitle.textContent = doc.data().negocio;
                // Imagen
                ...
                miNodoTexto.textContent = `${doc.data().horario}`;
                // Precio
                const miNodoPrecio = document.createElement('p');
                miNodoPrecio.classList.add('card-price');
                miNodoPrecio.textContent = `${divisa} ${doc.data().rangoPrecios}`;
                // Boton 
                ...
                //si add      miNodoBoton.addEventListener('click', anyadirProductoAlCarrito);
                // Insertamos
